    ...
    try:
        ...
        for pos in book_positions:
            ...
            if detected_name and detected_name.lower() == expected_name.lower():
                ...
                bin_location = {'x': 243.6987, 'y': 12.6211, 'z': 5.9898, 'r': 48.0537}
        ...
        print("⚠️ No matching book found in scanned positions.")
        return False
...
def main():
    ...
    excel_file = r"C:\\Users\Admin\Desktop\\Library Management\\Library_Books.xlsx"
    ...
    if not book_match.empty:
        ...
        positions = [
            {'x': 2.7254, 'y': -256.4918, 'z': 55.6899, 'r': -37.5342},
            {'x': 2.7254, 'y': -256.4918, 'z': 60.55, 'r': -37.539},
        ]
